...
class Controller extends BlockController
{
    ...
    public function getImageObject($fID, $width = 0, $height = 0, $crop = false) {
        if (empty($fID)) {
            $image = null;
            ...
            $image_arr = [];
            $image_arr['src'] = $file->getRelativePath();
            $image_arr['width'] = $file->getAttribute('width');
            $image_arr['height'] = $file->getAttribute('height');

            $image = (object)$image_arr;
        } else {
